...
let overrides =
      { update-monad = ../purescript-update-monad/spago.dhall as Location }

let additions =
      { smash =
        { dependencies = [ "prelude", "day", "record", "proxy" ]
        , repo = "https://github.com/arthurxavierx/purescript-smash.git"
        , version = "master"
        }
      , day =
        { dependencies = [ "exists", "pairing" ]
